...
# Ensure STATICFILES_DIRS exists if you're using additional static files
STATICFILES_DIRS = [
...
INSTALLED_APPS = [
    ...
    # 3rd party apps
    'crispy_forms',
    'crispy_bootstrap5',  # Use 'crispy_bootstrap4' if using Bootstrap 4
    'mapbox_location_field',
    'ckeditor',
    'ckeditor_uploader',
    'betterforms',
...
CRISPY_TEMPLATE_PACK = 'bootstrap5'  # ✅ Use 'bootstrap5' instead of 'bootstrap4'
from pathlib import Path  # Import Path module

BASE_DIR = Path(__file__).resolve().parent.parent  # Fix the path
