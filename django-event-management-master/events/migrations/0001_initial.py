# Generated by Django 2.2.28 on 2025-03-09 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('registered', 'Registered'), ('cancelled', 'Cancelled')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateField(auto_now_add=True)),
                ('updated_date', models.DateField(auto_now=True)),
                ('access_type', models.CharField(choices=[('our college', 'Our College'), ('other college', 'Other College'), ('both', 'Both')], default='both', max_length=25)),
